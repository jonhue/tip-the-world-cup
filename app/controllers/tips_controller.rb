...
class TipsController < ApplicationController
  ...
  def create
    ...
    if @tip.save
      redirect_to game_participant_tips_url(
        game_id: @game.to_param, participant_id: @participant.to_param
      ), notice: I18n.t('tips.create.success')
    else
      redirect_to game_participant_tips_url(
        game_id: @game.to_param, participant_id: @participant.to_param
      ), notice: I18n.t('tips.create.error')
    end
  end
  ...
  def update
    ...
    if @tip.update tip_params
      redirect_to game_participant_tips_url(
        game_id: @game.to_param, participant_id: @participant.to_param
      ), notice: I18n.t('tips.update.success')
    else
      redirect_to game_participant_tips_url(
        game_id: @game.to_param, participant_id: @participant.to_param
      ), notice: I18n.t('tips.update.error')
    end
  end
